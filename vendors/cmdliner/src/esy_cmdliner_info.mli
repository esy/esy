...
val term :
  ?args:args -> ?man_xrefs:Esy_cmdliner_manpage.xref list ->
  ?man:Esy_cmdliner_manpage.block list -> ?envs:env list -> ?exits:exit list ->
...
val term_man : term -> Esy_cmdliner_manpage.block list
val term_man_xrefs : term -> Esy_cmdliner_manpage.xref list
