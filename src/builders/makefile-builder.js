...
const fastReplaceStringSrc = require('fs').readFileSync(
  // This is how we resolve path to an external module which compatible with
  // both webpack and node module systems.
  // $FlowFixMe: ...
