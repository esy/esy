...
const esyBashPackageName = '@prometheansacrifice/esy-bash';
const esyBashPackageVersion =
  npmManifest.optionalDependencies &&
  npmManifest.optionalDependencies[esyBashPackageName];

if (!esyBashPackageVersion) {
  console.log(`esy-bash package "${esyBashPackageName}" not found in root package.json`);
  process.exit(-1);
}
...
const packageJson = JSON.stringify(
  {
    ...
    optionalDependencies: {
      [esyBashPackageName]: esyBashPackageVersion,
    },
  },
  null,
  2,
