...
# if the tarball came from NPM, untarred contents will just contain a package/ folder. rename this
URL=
if [ -d sources/package ]
then
    mv sources/package "sources/$PACKAGE_NAME"
fi
